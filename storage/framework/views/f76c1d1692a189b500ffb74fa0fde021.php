...
<head>
    ...
    <title><?php echo e(config('app.name', 'Horizon')); ?> — Student Uniform Distribution System</title>
    <meta name="description" content="<?php echo e(config('app.name', 'Horizon')); ?> is a web-based uniform distribution and inventory management system for university freshmen.">
    ...
    <div class="max-w-5xl mx-auto px-6 sm:px-8 h-14 flex items-center justify-between transition-all duration-300">
        ...
        <div class="flex items-center gap-2.5">
            ...
            <span class="text-sm font-bold text-white">
                <?php echo e(config('app.name', 'Horizon')); ?>
        ...
        <?php if(Route::has('login')): ?>
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(url('/dashboard')); ?>" class="cta-btn px-5 py-1.5 bg-white text-primary-700 hover:bg-primary-50 text-xs font-bold rounded-full transition-all shadow-sm">
                    Dashboard
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="cta-btn px-5 py-1.5 bg-white text-primary-700 hover:bg-primary-50 text-xs font-bold rounded-full transition-all shadow-sm">
                    Login
                </a>
            <?php endif; ?>
        <?php endif; ?>
...
<section class="hero-gradient pt-32 pb-24 px-6 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p class="text-primary-100 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
            <?php echo e(config('app.name', 'Horizon')); ?> replaces manual Google Form, barcode, and Excel recap processes
    ...
    <div class="max-w-3xl mx-auto mt-16 grid grid-cols-3 gap-4 relative z-10">
        ...
        <div class="glass-card rounded-xl p-5 text-center">
            <p class="text-xl font-bold text-white"><?php echo e($stat['value']); ?></p>
            <p class="text-xs text-primary-200 mt-1"><?php echo e($stat['label']); ?></p>
        </div>
        ...
        <div class="relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-base font-semibold text-gray-800 mb-2"><?php echo e($item['title']); ?></h3>
                    <p class="text-xs text-gray-500 leading-relaxed"><?php echo e($item['desc']); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<section id="fitur" class="py-20 px-6 bg-gray-50">
    <div class="max-w-4xl mx-auto">
        <div class="text-center mb-14">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Mengapa <?php echo e(config('app.name', 'Horizon')); ?>?</h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="feature-card bg-white rounded-2xl border border-gray-200 p-7">
                <div class="<?php echo e($colorCls['bg']); ?> w-12 h-12 rounded-xl flex items-center justify-center mb-5">
                    <svg class="w-6 h-6 <?php echo e($colorCls['icon']); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($feat['icon']); ?>"/>
                    </svg>
                </div>
                <h3 class="text-base font-semibold text-gray-800 mb-2"><?php echo e($feat['title']); ?></h3>
                <p class="text-sm text-gray-500 leading-relaxed"><?php echo e($feat['desc']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<footer class="bg-primary-950 py-8 px-6">
    <div class="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
        <div class="flex items-center gap-2">
            ...
            <span class="text-sm font-medium text-primary-200"><?php echo e(config('app.name', 'Horizon')); ?></span>
        </div>
        <p class="text-xs text-primary-400">&copy; <?php echo e(date('Y')); ?> Student Uniform Distribution System. All rights reserved.</p>
    </div>
</footer>
...
</html><?php /**PATH C:\laragon\www\Horizon-UniStock - Copy\resources\views/welcome.blade.php ENDPATH**/ ?>