        ...
        <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500"><?php echo e($student->email_pribadi ?? 'Belum diisi'); ?></p>
                </div>
                <a href="<?php echo e(route('profile.email.change')); ?>"
...
<?php /**PATH C:\laragon\www\Horizon-UniStock - Copy\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>