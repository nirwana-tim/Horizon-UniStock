...
<div x-data="{ show: true }" x-show="show"
     ...
     class="flex items-start gap-3 p-4 mb-4 rounded-lg border <?php echo e($c['bg']); ?> <?php echo e($c['text']); ?>">

    
    <svg class="w-5 h-5 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($c['icon_path']); ?>" />
    </svg>
    ...
    <button @click="show = false"
            class="<?php echo e($c['close']); ?> transition-colors ml-1 flex-shrink-0"
...
<?php /**PATH C:\laragon\www\Horizon-UniStock - Copy\resources\views/components/alert.blade.php ENDPATH**/ ?>