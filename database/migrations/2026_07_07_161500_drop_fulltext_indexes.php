...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('items', fn(Blueprint $t) => $t->dropFullText(['name', 'code', 'base_code']));
        Schema::table('faculties', fn(Blueprint $t) => $t->dropFullText('name'));
        Schema::table('study_programs', fn(Blueprint $t) => $t->dropFullText('name'));
        Schema::table('vendors', fn(Blueprint $t) => $t->dropFullText(['name', 'email', 'contact']));
