                ...
                <div class="p-6 text-gray-900">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button type="button" x-data="" @click="$dispatch('open-modal', 'import-stock-opname')" class="inline-flex items-center gap-1.5 px-4 py-2 border border-primary-500 text-primary-700 hover:bg-primary-50 rounded-md font-semibold text-xs uppercase tracking-widest transition">
