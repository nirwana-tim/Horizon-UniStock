                    ...
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            @if($batch->status === 'counted')
                                <form action="{{ route('inventory.stock-opname.approve', $batch) }}" method="POST" onsubmit="return confirm('Yakin ingin menyetujui stock opname ini? Adjustment akan dibuat otomatis.')">
                                    @csrf
