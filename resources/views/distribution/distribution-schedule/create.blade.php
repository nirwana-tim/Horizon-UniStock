<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Add Distribution Schedule') }}</h2>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('distribution.distribution-schedule.store') }}" method="POST"
                          x-data="{
                              ...
                              fetchItems() {
                                  axios.get('{{ route('distribution.distribution-schedule.fetch-items') }}', {
                                      params: {
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div @change="programLevelId = $event.target.value">
                                ...
                                @endphp
                                <x-searchable-select name="program_level_id" :options="$levelOptions" :value="old('program_level_id')" placeholder="-- All Levels --" />
