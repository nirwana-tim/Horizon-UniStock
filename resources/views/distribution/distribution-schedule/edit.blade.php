                    ...
                    <form action="{{ route('distribution.distribution-schedule.update', $distributionSchedule) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                @endphp
                                <x-searchable-select name="faculty_id" :options="$facultyOptions" :value="old('faculty_id', $distributionSchedule->faculty_id)" placeholder="-- Semua Fakultas --" />
                            ...
                            <div>
                                ...
                                @endphp
                                <x-searchable-select name="study_program_id" :options="$prodiOptions" :value="old('study_program_id', $distributionSchedule->study_program_id)" placeholder="-- Semua Prodi --" />
