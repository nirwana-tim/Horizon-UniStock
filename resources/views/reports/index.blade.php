                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="ml-4 text-lg font-semibold text-gray-900">Laporan Distribusi</h3>
                        </div>
                        <p class="text-sm text-gray-500 mb-4">Export data distribusi barang per periode ke Excel.</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="ml-4 text-lg font-semibold text-gray-900">Laporan Inventory</h3>
                        </div>
                        <p class="text-sm text-gray-500 mb-4">Export stok barang dan riwayat pergerakan stok.</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="ml-4 text-lg font-semibold text-gray-900">Laporan GPM</h3>
                        </div>
                        <p class="text-sm text-gray-500 mb-4">Export laba/rugi per item dan kategori.</p>
