        ...
        <div class="text-center pt-2">
            <p class="text-sm text-gray-500">
                ...
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="text-primary-700 font-medium hover:text-primary-800">Staff/Admin</a>
                @endif
                @if (Route::has('password.request') && Route::has('password.student.forgot'))
                    <span class="text-gray-300 mx-1">|</span>
                @endif
                @if (Route::has('password.student.forgot'))
                    <a href="{{ route('password.student.forgot') }}" class="text-primary-700 font-medium hover:text-primary-800">Mahasiswa</a>
                @endif
            </p>
        </div>
