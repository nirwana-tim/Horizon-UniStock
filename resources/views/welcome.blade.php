...
<head>
    ...
    <title>{{ config('app.name', 'Horizon') }} — Student Uniform Distribution System</title>
    <meta name="description" content="{{ config('app.name', 'Horizon') }} is a web-based uniform distribution and inventory management system for university freshmen.">
...
<section class="hero-gradient pt-32 pb-24 px-6 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p class="text-primary-100 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
            {{ config('app.name', 'Horizon') }} replaces manual Google Form, barcode, and Excel recap processes
...
<section id="fitur" class="py-20 px-6 bg-gray-50">
    <div class="max-w-4xl mx-auto">
        <div class="text-center mb-14">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Mengapa {{ config('app.name', 'Horizon') }}?</h2>
        </div>
...
<footer class="bg-primary-950 py-8 px-6">
    <div class="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
        <div class="flex items-center gap-2">
            ...
            <span class="text-sm font-medium text-primary-200">{{ config('app.name', 'Horizon') }}</span>
        </div>
