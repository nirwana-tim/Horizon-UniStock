                    ...
                    <form action="{{ route('students.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                @endphp
                                <x-searchable-select name="study_program_id" :options="$prodiOptions" :value="old('study_program_id')" placeholder="-- Select Study Program --" :required="true" />
                            ...
                            <div>
                                ...
                                @endphp
                                <x-searchable-select name="program_level_id" :options="$levelOptions" :value="old('program_level_id')" placeholder="-- Select Level --" :required="true" />
