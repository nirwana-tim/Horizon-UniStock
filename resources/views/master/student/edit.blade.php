                    ...
                    <form action="{{ route('students.update', $student) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                @endphp
                                <x-searchable-select name="study_program_id" :options="$prodiOptions" :value="old('study_program_id', $student->study_program_id)" placeholder="-- Pilih Prodi --" :required="true" />
                            ...
                            <div>
                                ...
                                @endphp
                                <x-searchable-select name="program_level_id" :options="$levelOptions" :value="old('program_level_id', $student->program_level_id)" placeholder="-- Pilih Level --" :required="true" />
