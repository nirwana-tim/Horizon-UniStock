<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Add Item Price') }}</h2>
                    ...
                    <form action="{{ route('master-data.item-price.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                @endphp
                                <x-searchable-select name="item_id" :options="$itemOptions" :value="old('item_id')" placeholder="-- Select Item --" :required="true" />
