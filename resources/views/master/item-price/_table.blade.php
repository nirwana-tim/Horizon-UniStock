                @forelse($itemPrices as $index => $itemPrice)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-right space-x-1">
                            <a href="{{ route('master-data.item-price.show', $itemPrice) }}" class="inline-flex items-center justify-center p-1.5 text-primary-600 hover:text-primary-800 hover:bg-primary-50 rounded-lg transition-colors" title="Lihat Detail">
                            ...
                            <x-delete-modal
                                ...
                                :iconOnly="true"
                            />
                            <a href="{{ route('master-data.item-price.edit', $itemPrice) }}" class="inline-flex items-center justify-center p-1.5 text-primary-600 hover:text-primary-800 hover:bg-primary-50 rounded-lg transition-colors" title="Edit Harga">
