            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6 flex items-center gap-3">
                        <form action="{{ route('master.stock-receive.destroy', $stockReceive) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus penerimaan ini?')">@csrf @method('DELETE')<x-danger-button>{{ __('Hapus') }}</x-danger-button></form>
                    </div>
