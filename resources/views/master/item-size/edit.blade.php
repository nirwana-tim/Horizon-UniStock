<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Edit Item Size') }}</h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('master-data.item-size.update', $itemSize) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mt-1 text-sm font-mono text-gray-900 bg-gray-100 p-2.5 rounded-md border border-gray-200">{{ $itemSize->code }}</p>
                        </div>
