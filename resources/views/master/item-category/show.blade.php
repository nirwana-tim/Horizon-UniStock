                ...
                <div class="p-6 text-gray-900">
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm font-mono text-gray-900">{{ $itemCategory->code }}</p>
                        </div>

                        <div>
                            <h3 class="text-sm font-medium text-gray-500">{{ __('Label') }}</h3>
                            <p class="mt-1 text-sm text-gray-900">{{ $itemCategory->label }}</p>
                        </div>
                    </div>

                    <div class="mt-6 pt-4 border-t border-gray-200">
                        <h3 class="text-sm font-medium text-gray-500 mb-3">{{ __('Item List') }}</h3>
                        @if($itemCategory->items->count())
