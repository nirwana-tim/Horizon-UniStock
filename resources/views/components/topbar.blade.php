...
<header class="bg-white border-b border-gray-200 h-14 flex items-center px-4 gap-4 flex-shrink-0 z-10">
    ...
    <div x-data="{ open: false }" class="relative">
        <button @click="open = !open"
            ...
            <div class="w-8 h-8 bg-primary-700 rounded-full flex items-center justify-center text-white text-xs font-bold uppercase">
