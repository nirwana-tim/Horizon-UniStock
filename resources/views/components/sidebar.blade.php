...
<aside x-data="{ collapsed: false, mobileOpen: false, userMenuOpen: false, masterOpen: {{ $masterOpen }}, distributionOpen: {{ $distributionOpen }}, studentsOpen: {{ $studentsOpen }}, inventoryOpen: {{ $inventoryOpen }}, reportsOpen: {{ $reportsOpen }}, systemOpen: {{ $systemOpen }} }" x-init="setTimeout(() => $el.classList.add('sidebar-transition'), 50)" @toggle-sidebar.window="mobileOpen = !mobileOpen"
    ...
    <div class="h-14 border-b border-gray-100 flex-shrink-0 flex items-center overflow-hidden"
        ...
        <a x-show="!collapsed" href="{{ route('dashboard') }}" class="flex items-center gap-2 min-w-0">
            ...
            <div class="min-w-0">
                <p translate="no" class="font-headline-sm text-headline-sm text-primary font-bold leading-tight truncate">{{ config('app.name', 'Horizon') }}</p>
            </div>
        </a>
    ...
    <div class="flex-1 overflow-y-auto custom-scroll">
        ...
        @hasanyrole(['admin', 'super_admin'])
            ...
            <div>
                ...
                <div x-show="studentsOpen && !collapsed" x-cloak
                    ...
                    <a href="{{ route('students.index') }}"
                        class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm {{ request()->routeIs('students.*') && !request()->routeIs('students.generate-index') && !request()->routeIs('students.credentials') ? 'text-primary-700 font-medium bg-primary-50' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50' }} transition-colors">
                        Student Data
                    </a>
                    ...
                    <a href="{{ route('students.credentials') }}"
                        class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm {{ request()->routeIs('students.credentials') ? 'text-primary-700 font-medium bg-primary-50' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50' }} transition-colors">
            ...
            @role('admin')
                ...
                <a href="{{ route('admin.user.index') }}" title="Kelola Akun"
                    class="flex items-center gap-3 px-2 py-2 rounded-lg text-sm {{ request()->routeIs('admin.user.*') ? 'sidebar-item-active' : 'sidebar-item' }}">
                    <svg aria-hidden="true" class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div>
                ...
                <div x-show="systemOpen && !collapsed" x-cloak
                    ...
                    <a href="{{ route('admin.user.index') }}"
                        class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm {{ request()->routeIs('admin.user.*') ? 'text-primary-700 font-medium bg-primary-50' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50' }} transition-colors">
