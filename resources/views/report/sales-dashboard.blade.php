<x-app-layout>
    ...
    <div x-data="salesDashboard" class="space-y-6">
        {{-- Loader --}}
        <div x-show="loading" class="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-xs transition-opacity duration-300">
            <div class="bg-white p-5 rounded-2xl shadow-xl flex flex-col items-center gap-3">
                ...
                <span class="text-sm font-medium text-gray-700">Loading Dashboard Data...</span>
            </div>
        </div>
